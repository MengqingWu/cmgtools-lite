...
class BPH4lDumpEvtList( Analyzer ):
    def __init__(self, cfg_ana, cfg_comp, looperName):
        super(BPH4lDumpEvtList,self).__init__(cfg_ana, cfg_comp, looperName)


    def declareHandles(self):
        super(BPH4lDumpEvtList, self).declareHandles()


    def beginLoop(self, setup):
        super(BPH4lDumpEvtList,self).beginLoop(setup)
    ...
    def endLoop(self, setup):
        super(BPH4lDumpEvtList,self).endLoop(setup)
