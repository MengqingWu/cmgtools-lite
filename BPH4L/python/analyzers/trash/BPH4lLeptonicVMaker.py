...
class BPH4lLeptonicVMaker( Analyzer ):
    def __init__(self, cfg_ana, cfg_comp, looperName):
        super(BPH4lLeptonicVMaker,self).__init__(cfg_ana, cfg_comp, looperName)
    ...
    def declareHandles(self):
        super(BPH4lLeptonicVMaker, self).declareHandles()


    def beginLoop(self, setup):
        super(BPH4lLeptonicVMaker,self).beginLoop(setup)
