from CMGTools.BPH4L.analyzers.bak.BPH4lEventInterpretationBase import *
from CMGTools.BPH4L.tools.Pair import Pair
import itertools
import ROOT
from array import array

class BPH4lMultiFinalState( BPH4lEventInterpretationBase ):
    def __init__(self, cfg_ana, cfg_comp, looperName):
        super(BPH4lMultiFinalState,self).__init__(cfg_ana, cfg_comp, looperName)
...
#        if abs(pdgid)==13:return self.mtrgsf(zpt)-self.mtrgsfe(zpt)
    ...
    def process(self, event):
        super(BPH4lMultiFinalState,self).process(event)
