...
from CMGTools.BPH4L.tools.JetReCalibrator import Type1METCorrector, setFakeRawMETOnOldMiniAODs
...
class BPH4lMETAnalyzer( Analyzer ):
    def __init__(self, cfg_ana, cfg_comp, looperName ):
        super(BPH4lMETAnalyzer,self).__init__(cfg_ana,cfg_comp,looperName)
    ...
    def declareHandles(self):
        super(BPH4lMETAnalyzer, self).declareHandles()
    ...
    def beginLoop(self, setup):
        super(BPH4lMETAnalyzer,self).beginLoop(setup)
...
setattr(BPH4lMETAnalyzer,"defaultConfig", cfg.Analyzer(
    class_object = BPH4lMETAnalyzer,
