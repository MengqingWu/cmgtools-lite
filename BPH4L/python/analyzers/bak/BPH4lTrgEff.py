...
class BPH4lTrgEff(Analyzer):
    def __init__(self, cfg_ana, cfg_comp, looperName):
        super(BPH4lTrgEff, self).__init__(cfg_ana, cfg_comp, looperName)
    ...
    def declareHandles(self):
        super(BPH4lTrgEff, self).declareHandles()
    ...
    def beginLoop(self,setup):
        super(BPH4lTrgEff,self).beginLoop(setup)
    ...
    def write(self,setup):
        super(BPH4lTrgEff, self).write(setup)
        self.trgeff.write()
