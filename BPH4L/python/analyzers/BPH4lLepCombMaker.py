    ...
    def process(self, event):
        ...
        for l1,l2,l3,l4 in combinations(event.selectedMuons, 4):
            ...
            if totalCharge==0:
                ...
                fourMuProb=self.QuadObjFactory.get4muVtxProb(l1.physObj,l2.physObj,l3.physObj,l4.physObj)
                print " Chi2 test for 4-mu common vertex: ", fourMuProb
                # == debug:
                lepP=[]
                lepN=[]
                ...
                pair1=Pair(lepP[0], lepN[0])
                pair2=Pair(lepP[1], lepN[1])
                #pair12=Pair(pair1, pair2)
                #print " [info] dR(1,2,12) = %.2f, %.2f, %.2f " % (pair1.deltaR(), pair2.deltaR(), pair12.deltaR())
                print " [info] dR(1p, 2p)  = %.2f, %.2f " % (pair1.deltaR(), pair2.deltaR())
