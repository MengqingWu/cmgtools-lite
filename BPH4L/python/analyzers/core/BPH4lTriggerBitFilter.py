...
class BPH4lTriggerBitFilter( Analyzer ):
    def __init__(self, cfg_ana, cfg_comp, looperName ):
        super(BPH4lTriggerBitFilter,self).__init__(cfg_ana,cfg_comp,looperName)
    ...
    def declareHandles(self):
        super(BPH4lTriggerBitFilter, self).declareHandles()
        self.handles['TriggerResults'] = AutoHandle( ('TriggerResults','',self.processName), 'edm::TriggerResults' )

    def beginLoop(self, setup):
        super(BPH4lTriggerBitFilter,self).beginLoop(setup)
