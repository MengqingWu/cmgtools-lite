# origin from /PhysicsTools/Heppy/python/analyzers/gen/GeneratorAnalyzer.py
# copied @ Feb-01-2017 by Mengqing w/ following changes:
#    -- modified to save gen decay products of Jpsi/Upsilon
