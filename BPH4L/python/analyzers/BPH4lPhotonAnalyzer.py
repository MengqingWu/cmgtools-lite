...
class BPH4lPhotonAnalyzer( Analyzer ):

    
    def __init__(self, cfg_ana, cfg_comp, looperName ):
        super(BPH4lPhotonAnalyzer,self).__init__(cfg_ana,cfg_comp,looperName)
    ...
    def declareHandles(self):
        super(BPH4lPhotonAnalyzer, self).declareHandles()
    ...
    def beginLoop(self, setup):
        super(BPH4lPhotonAnalyzer,self).beginLoop(setup)
...
setattr(BPH4lPhotonAnalyzer,"defaultConfig",cfg.Analyzer(
    class_object=BPH4lPhotonAnalyzer,
