...
def BPH4lmatchObjectCollection( objects, matchCollection,
...
class BPH4lJetAnalyzer( Analyzer ):
    ...
    def __init__(self, cfg_ana, cfg_comp, looperName):
        ...
        super(BPH4lJetAnalyzer,self).__init__(cfg_ana, cfg_comp, looperName)
    ...
    def declareHandles(self):
        super(BPH4lJetAnalyzer, self).declareHandles()
    ...
    def beginLoop(self, setup):
        super(BPH4lJetAnalyzer,self).beginLoop(setup)
        ...
        if self.cfg_comp.isMC:
            for jet in allJets:
                ...
                if self.genJets:
                    ...
                    pairs = BPH4lmatchObjectCollection( [jet], self.genJets, 0.2*0.2, 3)
...
setattr(BPH4lJetAnalyzer,"defaultConfig", cfg.Analyzer(
    debug=False,    
    class_object = BPH4lJetAnalyzer,
    jetCol = 'slimmedJets',
