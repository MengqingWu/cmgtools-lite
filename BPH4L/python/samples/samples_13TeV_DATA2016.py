...
MuOnia_Run2016B_ReRecoV1 = kreator.makeDataComponent("MuOnia_Run2016B_ReRecoV1", "/MuOnia/Run2016B-23Sep2016-v2/MINIAOD", "CMS", ".*root", jsonFilter=jsonFilter, json=json, run_range=run_range)
Charmonium_Run2016B_ReRecoV1 = kreator.makeDataComponent("Charmonium_Run2016B_ReRecoV1", "/Charmonium/Run2016B-23Sep2016-v2/MINIAOD", "CMS", ".*root", jsonFilter=jsonFilter, json=json, run_range=run_range)
...
MuOnia_Run2016B_ReRecoV2 = kreator.makeDataComponent("MuOnia_Run2016B_ReRecoV2", "/MuOnia/Run2016B-23Sep2016-v3/MINIAOD", "CMS", ".*root", jsonFilter=jsonFilter, json=json, run_range=run_range)
Charmonium_Run2016B_ReRecoV2 = kreator.makeDataComponent("Charmonium_Run2016B_ReRecoV2", "/Charmonium/Run2016B-23Sep2016-v3/MINIAOD", "CMS", ".*root", jsonFilter=jsonFilter, json=json, run_range=run_range)
...
MuOnia_Run2016E_ReRecoV1 = kreator.makeDataComponent("MuOnia_Run2016E_ReRecoV1", "/MuOnia/Run2016E-23Sep2016-v1/MINIAOD", "CMS", ".*root", jsonFilter=jsonFilter, json=json, run_range=run_range)
...
MuOnia_Run2016F_ReRecoV1 = kreator.makeDataComponent("MuOnia_Run2016F_ReRecoV1", "/MuOnia/Run2016F-23Sep2016-v1/MINIAOD", "CMS", ".*root", jsonFilter=jsonFilter, json=json, run_range=run_range)
...
MuOnia_Run2016G_ReRecoV1 = kreator.makeDataComponent("MuOnia_Run2016G_ReRecoV1", "/MuOnia/Run2016G-23Sep2016-v1/MINIAOD", "CMS", ".*root", jsonFilter=jsonFilter, json=json, run_range=run_range)
